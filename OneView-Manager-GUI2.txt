...
$tblTools.RowCount = 2
$tblTools.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 20))) | Out-Null
$tblTools.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 20))) | Out-Null
$tblTools.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 20))) | Out-Null
$tblTools.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 20))) | Out-Null
$tblTools.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 20))) | Out-Null
...
$btnUpdate.Margin = New-Object System.Windows.Forms.Padding(0, 0, 3, 0)
...
$tblTools.Controls.Add($btnUpdate, 0, 0)

# Button: Config Backup
...
# Button: Rackmount Firmware (Reihe 1, Spalte 4)
$btnRackFirmware = New-Object System.Windows.Forms.Button
$btnRackFirmware.Text = "Rackmount Firmware"
$btnRackFirmware.Dock = [System.Windows.Forms.DockStyle]::Fill
$btnRackFirmware.Margin = New-Object System.Windows.Forms.Padding(3, 0, 0, 3)
$btnRackFirmware.BackColor = [System.Drawing.Color]::FromArgb(20, 80, 90)
$btnRackFirmware.ForeColor = [System.Drawing.Color]::White
$btnRackFirmware.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
$btnRackFirmware.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
$tblTools.Controls.Add($btnRackFirmware, 4, 0)
...
$tblVLAN = New-Object System.Windows.Forms.TableLayoutPanel
$tblVLAN.Location = New-Object System.Drawing.Point(10, 22)
$tblVLAN.Size = New-Object System.Drawing.Size(748, 46)
$tblVLAN.Anchor = [System.Windows.Forms.AnchorStyles]::Top -bor [System.Windows.Forms.AnchorStyles]::Left -bor [System.Windows.Forms.AnchorStyles]::Right
$tblVLAN.ColumnCount = 3
$tblVLAN.RowCount = 1
$tblVLAN.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 33.33))) | Out-Null
$tblVLAN.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 33.33))) | Out-Null
$tblVLAN.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 33.34))) | Out-Null
$tblVLAN.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Percent, 100))) | Out-Null
$grpVLAN.Controls.Add($tblVLAN)
...
$tblVLAN.Controls.Add($btnImport, 0, 0)
...
$tblVLAN.Controls.Add($btnBackup, 1, 0)
...
$tblVLAN.Controls.Add($btnMultiDeploy, 2, 0)

# ============================================================================
#  GroupBox: Network Sets
# ============================================================================
...
$tblNS = New-Object System.Windows.Forms.TableLayoutPanel
$tblNS.Location = New-Object System.Drawing.Point(10, 22)
$tblNS.Size = New-Object System.Drawing.Size(748, 46)
$tblNS.Anchor = [System.Windows.Forms.AnchorStyles]::Top -bor [System.Windows.Forms.AnchorStyles]::Left -bor [System.Windows.Forms.AnchorStyles]::Right
$tblNS.ColumnCount = 2
$tblNS.RowCount = 1
$tblNS.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 50))) | Out-Null
$tblNS.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 50))) | Out-Null
$tblNS.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Percent, 100))) | Out-Null
$grpNS.Controls.Add($tblNS)
...
$btnNSImport.Margin = New-Object System.Windows.Forms.Padding(0, 0, 3, 0)
...
$tblNS.Controls.Add($btnNSImport, 0, 0)
...
$btnNSBackup.Margin = New-Object System.Windows.Forms.Padding(3, 0, 0, 0)
...
$tblNS.Controls.Add($btnNSBackup, 1, 0)
...
$btnRackFirmware.Add_Click({
    ...
    Write-GUILog "Starte Rackmount Firmware Update Tool…" -Color ([System.Drawing.Color]::Orange)
    Start-Process pwsh -ArgumentList "-NoProfile -File `"$rackFwScript`""
})
...
function Show-ReadmeHelp {
    try {
        ...
        Write-GUILog "Hilfe wird geoeffnet..." -Color ([System.Drawing.Color]::Gray)
        ...
        try {
            ...
            Write-GUILog "Markdown-Konvertierung fehlgeschlagen ($($_.Exception.Message)) - Rohtext-Fallback." -Color ([System.Drawing.Color]::Orange)
...
'@
        ...
        # ShellExecute-Aufruf, damit die .html-Dateizuordnung zuverlaessig greift.
        $psi = New-Object System.Diagnostics.ProcessStartInfo
        $psi.FileName = $tmpHtml
        $psi.UseShellExecute = $true
        [void][System.Diagnostics.Process]::Start($psi)
        Write-GUILog "Hilfe im Standardbrowser geoeffnet." -Color ([System.Drawing.Color]::Green)
    } catch {
